...
// Imposta il tipo di business e lo stile desiderato
const businessType = 'restaurant';
const style = 'modern';

// Genera design completo per il business specificato
await designIntelligence.generateCompleteDesignRecommendation(businessType, { style });
